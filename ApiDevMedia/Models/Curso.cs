...
namespace ApiDevMedia.Models
{
    ...
    public class Curso
    {
        ...
        [MaxLength(100, ErrorMessage = "O título do do curso só pode conter até 100 caracteres.")]
        ...
        [Range(1, Int32.MaxValue, ErrorMessage = "A carga horária deve ser pelo menos de 1h.")]
